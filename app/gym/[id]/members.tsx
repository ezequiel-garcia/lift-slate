  ...
  if (role === "admin") {
    return (
      <View className="px-2.5 py-0.5 rounded-full bg-accent">
        <Text className="text-bg text-[11px] font-bold">ADMIN</Text>
      </View>
    );
  }
  if (role === "coach") {
    return (
      <View className="px-2.5 py-0.5 rounded-full bg-surface2 border border-border">
        <Text className="text-foreground text-[11px] font-bold">COACH</Text>
      </View>
    );
  }
  return (
    <View className="px-2.5 py-0.5 rounded-full bg-surface2">
      <Text className="text-muted text-[11px] font-bold">ATHLETE</Text>
    </View>
  );
}
  ...
  return (
    <SafeAreaView className="flex-1 bg-bg" edges={["top"]}>
      ...
      <View className="px-5 pb-3">
        <View className="bg-surface rounded-xl flex-row items-center px-3 gap-2">
          <Ionicons name="search" size={16} color={colors.muted} />
          <TextInput
            className="flex-1 text-foreground text-[15px] py-3"
