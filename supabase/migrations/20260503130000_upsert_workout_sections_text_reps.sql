-- sets/reps are TEXT (see 20260503000000_sets_reps_text.sql).
-- The previous upsert_workout_sections still cast them to INTEGER, which
-- fails for values like "8-12" or "AMRAP". Recreate without those casts.
